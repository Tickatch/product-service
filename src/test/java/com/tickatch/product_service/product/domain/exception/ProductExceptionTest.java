...
class ProductExceptionTest {
  ...
  class 생성자_ErrorCode와_Args_테스트 {
    ...
    void ErrorCode와_단일_인자로_예외를_생성할_수_있다() {
      ...
      ProductException exception =
          new ProductException(ProductErrorCode.PRODUCT_NOT_FOUND, productId);
    ...
    void ErrorCode와_다중_인자로_예외를_생성할_수_있다() {
      ...
      ProductException exception =
          new ProductException(
              ProductErrorCode.PRODUCT_STATUS_CHANGE_NOT_ALLOWED, currentStatus, targetStatus);
  ...
  class 생성자_ErrorCode와_Cause_그리고_Args_테스트 {
    ...
    void ErrorCode_원인예외_인자로_예외를_생성할_수_있다() {
      ...
      ProductException exception =
          new ProductException(ProductErrorCode.PRODUCT_NOT_FOUND, cause, productId);
  ...
  class 실제_사용_시나리오_테스트 {
    ...
    void 상태_변경_실패_시나리오() {
      ProductException exception =
          new ProductException(
              ProductErrorCode.PRODUCT_STATUS_CHANGE_NOT_ALLOWED, "DRAFT", "SOLD_OUT");
