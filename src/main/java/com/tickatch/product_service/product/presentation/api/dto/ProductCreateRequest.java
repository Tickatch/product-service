...
public record ProductCreateRequest(
    ...
    // ========== 일정 (필수) ==========
    @Schema(description = "행사 시작 일시", example = "2025-03-01T19:00:00", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "행사 시작 시간은 필수입니다")
    LocalDateTime startAt,
    @Schema(description = "행사 종료 일시", example = "2025-03-01T21:30:00", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "행사 종료 시간은 필수입니다")
    LocalDateTime endAt,
    @Schema(description = "예매 시작 일시", example = "2025-02-01T10:00:00", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "예매 시작 시간은 필수입니다")
    LocalDateTime saleStartAt,
    @Schema(description = "예매 종료 일시", example = "2025-02-28T23:59:59", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    String artHallName,
    @Schema(description = "공연장 주소", example = "서울시 송파구 올림픽로 424", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "1인당 최대 예매 매수", example = "4", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "입장 시작 시간 (공연 n분 전)", example = "30", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  public ProductCreateCommand toCommand(String sellerId) {
    return ProductCreateCommand.builder()
        ...
        // 좌석 정보
        .seatGradeInfos(seatGradeInfos.stream()
            .map(sg -> new SeatGradeInfo(sg.gradeName(), sg.price(), sg.totalSeats()))
            .toList())
        .seatCreateInfos(seatCreateInfos.stream()
