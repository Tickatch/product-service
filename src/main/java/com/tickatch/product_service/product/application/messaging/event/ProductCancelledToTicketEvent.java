...
/**
 * Ticket(티켓) 서비스로 전달되는 상품 취소 이벤트.
 *
 * <p>상품이 취소되면 해당 상품의 모든 티켓을 취소 처리해야 한다.
 *
 * <p>이벤트 정보:
 *
 * <ul>
 *   <li>Aggregate Type: Product
 *   <li>Routing Key: product.cancelled.ticket
 *   <li>대상 서비스: ticket-service
 * </ul>
 *
 * @author Tickatch
 * @since 1.0.0
 * @see ProductCancelledToReservationSeatEvent
 * @see ProductCancelledToReservationEvent
 */
@Getter
public class ProductCancelledToTicketEvent extends DomainEvent {

  private static final String AGGREGATE_TYPE = "Product";
  private static final String ROUTING_KEY = "product.cancelled.ticket";
   ...
   */
  public ProductCancelledToTicketEvent(Long productId) {
    super();
   ...
   */
  @JsonCreator
  public ProductCancelledToTicketEvent(
